...
struct Window : public QMainWindow {
    ...
    /// @brief Respuesta a un cambio del estado de la generación de coordenadas de textura del material
    /// @param state el nuevo valor del estado de la generación de coordenadas
